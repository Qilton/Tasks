...
const signup = () => {
  return (
    ...
    <div className='flex justify-center'><input type="button" value="Signup" className='px-5 py-2 rounded-lg bg-green-500 text-white font-bold text-lg cursor-pointer' /></div>
    </form>
